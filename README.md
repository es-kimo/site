...
React 동작 원리를 직접 코드로 확인해보는 실험실입니다. `packages/react-lab`의 실험을 셸과 분리된
자기 루트에 마운트하고, StrictMode 토글·다시 마운트·커밋 기록·콘솔 추적을 제공합니다. 로컬 전용입니다.
...
| `react-lab`         | React 동작 원리 실험 모음. 실험 소스의 단일 진실이며 lab 앱과 블로그가 함께 소비 |
